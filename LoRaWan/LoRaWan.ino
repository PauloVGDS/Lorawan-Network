...
/*Região LoraWan, EU915E6 permitido no Brasil*/
...
/*ADR enable(Adaptative Data Ratio)*/
bool loraWanAdr = true;
/* Indicates if the node is sending confirmed or unconfirmed messages */
bool isTxConfirmed = true;
uint8_t appPort = 2; // Identificador númerico usado para diferenciar os tipos de dados enviados*/
uint8_t confirmedNbTrials = 4; // Número de Tentativas de transmissão antes de desistir
